...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends python3 python3-pip python3-dev r-base build-essential cmake bash gawk bsdmainutils libncurses5-dev libncursesw5-dev
...
COPY ["./tools/correct_micro_homology.AWK", "tools/align_align.py", "/app/tools/"]
