...
# "${project_path}/barcode/tools/run_kpLogo.sh" "$project_path/barcode/test/A2-g1n-3.fq" <(sed '1~2d' "${spliter2}.fa") <("${project_path}/barcode/sx/get_sgRNA.sh" <${csvfile}) weight
# "${project_path}/barcode/tools/trouble_shooting.r" "${fqR1}" "${spliter2}" "${csvfile}" -9999
