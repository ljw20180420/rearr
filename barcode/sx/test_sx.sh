...
# $project_path/barcode/tools/demultiplex.sh "${fqR1}" "${fqR2}" "${spliter1}" "${spliter2}" "${sgRNAfile}" 100 30 $ref12 30 >"${fqR1}.demultiplex"
# $project_path/barcode/tools/barcode_align.sh "${fqR1}" 50 10 $(cat "${fqR1}.total") <"${fqR1}.demultiplex" >"${fqR1}.alg" 3>"${fqR1}.table"
