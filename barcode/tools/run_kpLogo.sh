...
case $method in
    "thres")
        barcode/kpLogo/bin/kpLogo "$fq1.kpLogo.weight.thres" -o "$fq1.kpLogo" -region 15,20 -weighted -k 1
    ;;
    "weighted"|"weight")
        barcode/kpLogo/bin/kpLogo "$fq1.kpLogo.weight" -o "$fq1.kpLogo" -region 15,20 -weighted -k 1
    ;;
