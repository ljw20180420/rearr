...
# Generate the github pages documentation for this project. The documentation for core/Rearrangement is generated by doxygen. bash shells are transformed to executable markdown by the track at https://gist.github.com/bwoods/1c25cb7723a06a076c2152a2781d4d49. awk scripts are wrapped by the corresponding code block in markdown.
