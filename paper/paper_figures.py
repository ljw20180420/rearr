...
for label, ax in axs.items():
    ...
    fig.savefig("paper/figures/stagger_cut.png", bbox_inches="tight", pad_inches=0, dpi=300)
...
for label, ax in axs.items():
    ...
    fig.savefig("paper/figures/indel_concept_disaster_microhomology.png", bbox_inches="tight", pad_inches=0, dpi=300)
...
fig.savefig("paper/figures/defects.png", bbox_inches="tight", pad_inches=0, dpi=300)
...
fig.savefig("paper/figures/double_cut_rearrangement.png", bbox_inches="tight", pad_inches=0, dpi=300)
