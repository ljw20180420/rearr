...
do
    ...
    sxExtractSpliter)
        ...
        ;;
    demultiplex)
        demultiplex.sh test/A2-g1n-3.fq.count sx/csvfiles/final_hgsgrna_libb_all_0811_NGG_scaffold_nor_G1.csv.primer+barcode sx/csvfiles/final_hgsgrna_libb_all_0811_NGG_scaffold_nor_G1.csv.adapter+sgRNA+scaffold 30 100
        ;;
