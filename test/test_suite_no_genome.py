...
from .test_sx_cut_r2_adapter_filter_cumulate.test_sx_cut_r2_adapter_filter_cumulate import (
    TestSxCumulateToMapCutAdaptSpliter,
    TestSxCutR2AdapterFilterCumulate,
)
from .test_sx_extract_marker.test_sx_extract_marker import TestSxExtractMarker
...
def suite_no_genome():
    ...
    suite.addTest(
        TestSxCumulateToMapCutAdaptSpliter("test_sx_cumulate_to_map_cut_adapt_spliter")
    )
    suite.addTest(
        TestSxCutR2AdapterFilterCumulate("test_sx_cut_r2_adapter_filter_cumulate")
    )
    suite.addTest(TestSxExtractMarker("test_sx_extract_marker"))
