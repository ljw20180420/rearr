...
ref1 <- reflines[1] |> substring(1, ref1len) |> toupper()
ref2 <- reflines[1] |> substring(ref1len + 1) |> toupper()
ref1vec <- str_split_1(ref1, "")
ref2vec <- str_split_1(ref2, "")
```
